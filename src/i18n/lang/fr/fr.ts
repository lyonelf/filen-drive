const fr: {
    ...
    na: "N/A",
    listEmpty_1: "Aucun fichier ou dossier de partagé avec vous",
    listEmpty_2: "Lorsque quelqu'un partagera des fichiers ou dossiers avec vous, ils apparaîtront ici",
    listEmpty_3: "Aucun fichier ou dossier de partagé avec d'autres",
    ...
    referInfo2: "Pour chaque personne que vous parrainerez sur Filen, vous recevrez __STORAGE__ - et elle aussi recevra __OTHER_STORAGE__. Elle pourra s'enregistrer pour une souscription de son choix et vous recevrez ensuite une commission de parrainage. Celle-ci est de __THRESHOLD__€. Votre taux est de __RATE__%.",
